...
from movies.views import movies_view, movie_detail, add_review, actor_views, filter_movie, add_rating, movie_paginator


urlpatterns = [
    path('', movies_view),
    path('page/<int:page_number>', movie_paginator, name='paginator'),
